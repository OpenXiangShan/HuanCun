...
//  oc.set := req.set
  ...
  oc.set := Mux(req.fromB, req.set, replace_release_set(associativePolicy.get_func_id(self_meta.way)))
  ...
  val nest_c_hash_match = Mux(
    nest_c_way_match,
    req_hash_set(associativePolicy.get_func_id(self_meta.way)) === nest_c_hash_set(associativePolicy.get_func_id(self_meta.way)),
    false.B
  )
...
//    nest_c_set_match &&
  ...
  val nest_b_hash_match = Mux(
    nest_b_way_match,
    req_hash_set(associativePolicy.get_func_id(self_meta.way)) === nest_b_hash_set(associativePolicy.get_func_id(self_meta.way)),
    false.B
  )
