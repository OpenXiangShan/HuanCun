...
class Directory(implicit p: Parameters)
  ...
  XSPerfAccumulate(cacheParams, "selfdir_A_req", req_r.replacerInfo.channel(0) && RegNext(resp.valid))
  XSPerfAccumulate(cacheParams, "selfdir_A_hit", req_r.replacerInfo.channel(0) && RegNext(resp.valid) && resp.bits.self.hit)
  XSPerfAccumulate(cacheParams, "selfdir_B_req", req_r.replacerInfo.channel(1) && RegNext(resp.valid))
  XSPerfAccumulate(cacheParams, "selfdir_B_hit", req_r.replacerInfo.channel(1) && RegNext(resp.valid) && resp.bits.self.hit)
  XSPerfAccumulate(cacheParams, "selfdir_C_req", req_r.replacerInfo.channel(2) && RegNext(resp.valid))
  XSPerfAccumulate(cacheParams, "selfdir_C_hit", req_r.replacerInfo.channel(2) && RegNext(resp.valid) && resp.bits.self.hit)
  ...
  val perfEvents = Seq(
    ("selfdir_A_req     ", req_r.replacerInfo.channel(0) && RegNext(resp.valid)                      ),
    ("selfdir_A_hit     ", req_r.replacerInfo.channel(0) && RegNext(resp.valid) && resp.bits.self.hit),
    ("selfdir_B_req     ", req_r.replacerInfo.channel(1) && RegNext(resp.valid)                      ),
    ("selfdir_B_hit     ", req_r.replacerInfo.channel(1) && RegNext(resp.valid) && resp.bits.self.hit),
    ("selfdir_C_req     ", req_r.replacerInfo.channel(2) && RegNext(resp.valid)                      ),
    ("selfdir_C_hit     ", req_r.replacerInfo.channel(2) && RegNext(resp.valid) && resp.bits.self.hit),
